        ...
        <section className="mt-6 mb-6 sm:mb-12 sm:pt-12">
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="max-w-2xl mx-auto text-center">
              <Link
                href="/"
                class="inline-flex justify-between items-center px-1 pr-4 mb-2 text-sm text-black rounded-full"
                role="alert"
              >
                <span class="text-medium bg-primary-600 rounded-full text-white px-3 py-1.5 mr-3 bg-indigo-600">
              ...
              <p className="mt-5 text-4xl font-bold leading-tight text-black sm:leading-tight sm:text-5xl lg:text-6xl lg:leading-tight font-pj">
                ...
                <span className="relative inline-flex sm:inline">
                  ...
                  <span className="relative"> MotionUI </span>
                </span>
              </p>
