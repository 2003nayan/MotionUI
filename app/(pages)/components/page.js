      ...
      <section className="py-10 bg-white sm:py-12 lg:py-16">
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="max-w-md mx-auto text-center">
            ...
            <p className="mt-4 text-md leading-7 text-black font-semibold">
              View from our plethora of components built
            </p>
            <span className="text-transparent font-semibold text-md bg-clip-text bg-gradient-to-r from-[#4F46E5] to-[#E114E5]">
            ...
            <div className="relative group">
              ...
              <div className="flex items-start justify-between mt-2 space-x-4">
                <div>
                  <h3 className="text-xs font-bold text-gray-900 sm:text-sm md:text-base">
                    <Link
                      href="/components/newsletter-sections"
                      title="Banner Components"
                    >
                      Newsletter Sections
                      <span
