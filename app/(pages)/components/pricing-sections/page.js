...
const ListPricingSectionComponents = () => {
    return (
        <>
            <Navbar />
                            ...
                            <div className="flex items-start justify-between mt-4 space-x-4">
                                <div>
                                    <h3 className="text-xs font-bold text-black hover:text-indigo-600 sm:text-sm md:text-base">
                                        <Link href="/components/pricing-sections">
                                            First Pricing-Section Component
                        ...
                        <div className="relative group">
                            ...
                            <div className="flex items-start justify-between mt-4 space-x-4">
                                <div>
                                    <h3 className="text-xs font-bold text-black hover:text-indigo-600 sm:text-sm md:text-base">
                                        <Link href="/components/pricing-sections">
                                            Second Pricing-Section Component
                                            <span className="absolute inset-0" aria-hidden="true"></span>
                                        </Link>
                                    </h3>
                                </div>
                        ...
                        <div className="relative group">
                            ...
                            <div className="flex items-start justify-between mt-4 space-x-4">
                                <div>
                                    <h3 className="text-xs font-bold text-black hover:text-indigo-600 sm:text-sm md:text-base">
                                        <Link href="/components/pricing-sections">
                                            Third Pricing-Section Component
                                            <span className="absolute inset-0" aria-hidden="true"></span>
                                        </Link>
                                    </h3>
                                </div>
                        ...
                        <div className="relative group">
                            ...
                            <div className="flex items-start justify-between mt-4 space-x-4">
                                <div>
                                    <h3 className="text-xs font-bold text-black hover:text-indigo-600 sm:text-sm md:text-base">
                                        <Link href="/components/pricing-sections">
                                            Fourth Pricing-Section Component
                                            <span className="absolute inset-0" aria-hidden="true"></span>
                                        </Link>
                                    </h3>
                                </div>
...
export default ListPricingSectionComponents;
