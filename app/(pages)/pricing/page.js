  ...
  const pricingPlans = [
    {
      title: "Basic Plan",
      description:
        "All the components available on the website. Choose from a plethora of components built using Tailwind CSS.",
      price: "0",
      isMostPopular: false,
      plansFeatures: [
    ...
    },
    {
      title: "Pages",
      description:
        "Best for early stage startups & businesses that need a marketing site and ongoing developmental work",
      price: 999,
      isMostPopular: false,
      plansFeatures: [
        ...
        <div className="max-w-screen-xl mx-auto px-4 text-black md:px-8">
          <div className="relative max-w-xl mx-auto sm:text-center">
            <h3 className="text-black text-3xl font-semibold sm:text-4xl bg-gradient-to-r from-indigo-600 from-10% via-red-500 via-100% to-violet-600 to-100% inline-block text-transparent bg-clip-text">
              Need custom components or websites? We've got your back
            </h3>
            <div className="mt-3 max-w-xl">
              <p>
                From custom components to complete website tailored to your
                needs. Simple pricing, no hidden fees.
              </p>
            </div>
          </div>
              ...
              >
                ...
                <div className="p-8 space-y-4 border-b">
                  ...
                  <Link href="/stripe-checkout">
                    <button className="px-4 py-3 mt-4 rounded-lg w-full font-semibold text-sm duration-300 text-white bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500 active:from-indigo-700 active:to-violet-700 transform hover:scale-[1.02] transition-all shadow-md hover:shadow-lg">
                      Get Started
                    </button>
                  </Link>
                  <p className="text-xs text-center text-gray-500 mt-2">Payment integration coming soon</p>
                </div>
